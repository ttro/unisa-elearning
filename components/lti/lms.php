...
require_once("util/lti_util.php");
  ...
  if ( ! $key ) $key = $ltiConfig['key'];
  $secret = trim($_REQUEST["secret"]);
  if ( ! $secret ) $secret = $ltiConfig['secret'];
  ...
  $lmsdata = array(
    ...
    'launch_presentation_width' => '800px',
    'launch_presentation_height' => '100%',
	'custom_skip_thankyou' => 'false',
	'custom_force_restart' => 'false',
    );
